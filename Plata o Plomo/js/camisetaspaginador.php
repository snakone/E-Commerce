...
$PagTam = 10;
	...
	if (isset($_GET['pag']))
		...
		$todos = "SELECT count(*) as num from camisetas";
...
$Resultado=mysql_query("SELECT * FROM camisetas ORDER BY `idproducto` LIMIT $inicio, $PagTam",$con);
...
while($MostrarFila=mysql_fetch_array($Resultado)){
	...
	echo "<td width='10%'><strong>".$MostrarFila['ref']."</strong></td>";
	echo "<td width='15%'>".$MostrarFila['nombre']."</td>";
	echo "<td width='5%'>".$MostrarFila['talla']." </td>";
	echo "<td width='10%'><a style='border:2px solid black;background-color:".$MostrarFila['color'].";'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></td>";
	echo "<td width='7.5%'>".$MostrarFila['sexo']." </td>";
