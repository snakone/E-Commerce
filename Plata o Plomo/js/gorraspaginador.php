...
$PagTam = 10;
	...
	if (isset($_GET['pag']))
		...
		$todos = "SELECT count(*) as num from gorras";
...
$Resultado=mysql_query("SELECT * FROM gorras ORDER BY `idproducto` LIMIT $inicio, $PagTam",$con);
...
while($MostrarFila=mysql_fetch_array($Resultado)){
	...
	echo "<td width='10%'>".$MostrarFila['marca']."</td>";
