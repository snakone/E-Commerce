...
$PagTam = 10;
	...
	if (isset($_GET['pag']))
		...
		$todos = "SELECT count(*) as num from calcetines";
...
$Resultado=mysql_query("SELECT * FROM calcetines ORDER BY `idproducto` LIMIT $inicio, $PagTam",$con);
...
while($MostrarFila=mysql_fetch_array($Resultado)){
	...
	echo "<td width='17.5%'>".$MostrarFila['nombre']."</td>";
	echo "<td width='5%'>".$MostrarFila['medida']." </td>";
