...
$PagTam = 10;
	...
	if (isset($_GET['pag']))
		...
		$todos = "SELECT count(*) as num from tablas";
...
$Resultado=mysql_query("SELECT * FROM tablas ORDER BY `idproducto` LIMIT $inicio, $PagTam",$con);
...
while($MostrarFila=mysql_fetch_array($Resultado)){
	...
	echo "<td width='20%'><strong>".$MostrarFila['ref']."</strong></td>";
	echo "<td width='15%'>".$MostrarFila['nombre']."</td>";
	echo "<td width='7.5%'>".$MostrarFila['medida']."\"</td>";
