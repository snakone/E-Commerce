...
$PagTam = 10;
	...
	if (isset($_GET['pag']))
		...
		$todos = "SELECT count(*) as num from ruedas";
...
$Resultado=mysql_query("SELECT * FROM ruedas ORDER BY `idproducto` LIMIT $inicio, $PagTam",$con);
...
while($MostrarFila=mysql_fetch_array($Resultado)){
	...
	echo "<td width='5%'>".$MostrarFila['medida']." mm</td>";
